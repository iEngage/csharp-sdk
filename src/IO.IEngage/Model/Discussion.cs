...
namespace IO.IEngage.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Discussion :  IEquatable<Discussion>, IValidatableObject
    {
        /// <summary>
        ...
        public Discussion(long? DiscussionId = null, User User = null, string Subject = null, string Description = null, DateTime? CreationTime = null, string Sentiment = null, Sentiment SentimentDetails = null, double? SentimentWeightage = null, List<NER> Entity = null)
        {
