...
namespace IO.IEngage.Api
{
    ...
    public interface IIdeaApi : IApiAccessor
    {
        ...
        /// <param name="accessToken">Unique session token for user. To get access token user will have to authenticate (optional)</param>
        /// <returns>ApiResponse of VerveResponseIdea</returns>
        ApiResponse<VerveResponseIdea> RateIdea_0WithHttpInfo (long? userId, long? ideaId, string ideaStage, string _parameter, double? rating, string requesterId, string clientToken, string fields = null, string accessToken = null);
        /// <summary>
        ...
        /// <param name="accessToken">Unique session token for user. To get access token user will have to authenticate (optional)</param>
        /// <returns>Task of VerveResponseIdea</returns>
        System.Threading.Tasks.Task<VerveResponseIdea> RateIdea_0Async (long? userId, long? ideaId, string ideaStage, string _parameter, double? rating, string requesterId, string clientToken, string fields = null, string accessToken = null);
        ...
        /// <param name="accessToken">Unique session token for user. To get access token user will have to authenticate (optional)</param>
        /// <returns>Task of ApiResponse (VerveResponseIdea)</returns>
        System.Threading.Tasks.Task<ApiResponse<VerveResponseIdea>> RateIdea_0AsyncWithHttpInfo (long? userId, long? ideaId, string ideaStage, string _parameter, double? rating, string requesterId, string clientToken, string fields = null, string accessToken = null);
        /// <summary>
        /// Get list of matching ideas
        /// </summary>
        /// <remarks>
    ...
    public partial class IdeaApi : IIdeaApi
    {
        ...
        /// <param name="accessToken">Unique session token for user. To get access token user will have to authenticate (optional)</param>
        /// <returns>VerveResponseIdea</returns>
        public VerveResponseIdea RateIdea_0 (long? userId, long? ideaId, string ideaStage, string _parameter, double? rating, string requesterId, string clientToken, string fields = null, string accessToken = null)
        {
             ApiResponse<VerveResponseIdea> localVarResponse = RateIdea_0WithHttpInfo(userId, ideaId, ideaStage, _parameter, rating, requesterId, clientToken, fields, accessToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="accessToken">Unique session token for user. To get access token user will have to authenticate (optional)</param>
        /// <returns>ApiResponse of VerveResponseIdea</returns>
        public ApiResponse< VerveResponseIdea > RateIdea_0WithHttpInfo (long? userId, long? ideaId, string ideaStage, string _parameter, double? rating, string requesterId, string clientToken, string fields = null, string accessToken = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
        ...
        /// <param name="accessToken">Unique session token for user. To get access token user will have to authenticate (optional)</param>
        /// <returns>Task of VerveResponseIdea</returns>
        public async System.Threading.Tasks.Task<VerveResponseIdea> RateIdea_0Async (long? userId, long? ideaId, string ideaStage, string _parameter, double? rating, string requesterId, string clientToken, string fields = null, string accessToken = null)
        {
             ApiResponse<VerveResponseIdea> localVarResponse = await RateIdea_0AsyncWithHttpInfo(userId, ideaId, ideaStage, _parameter, rating, requesterId, clientToken, fields, accessToken);
             return localVarResponse.Data;
        ...
        /// <param name="accessToken">Unique session token for user. To get access token user will have to authenticate (optional)</param>
        /// <returns>Task of ApiResponse (VerveResponseIdea)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<VerveResponseIdea>> RateIdea_0AsyncWithHttpInfo (long? userId, long? ideaId, string ideaStage, string _parameter, double? rating, string requesterId, string clientToken, string fields = null, string accessToken = null)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling IdeaApi->RateIdea_0");
        ...
        /// <summary>
        /// Share idea   This service allows a user to share a idea. The following fields(key:value) are required to be present in the Idea JSON object. Refer to the Model &amp; Model Schema of the expected JSON Object for the body of this API.&lt;/br&gt;&lt;b&gt;Required fields &lt;/br&gt;1. ideaTitle &lt;/br&gt;2. ideaDescription &lt;/br&gt;3. group: { groupId } &lt;/br&gt;
        /// </summary>
        /// <exception cref="IO.IEngage.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="requesterId">requesterId can be user id OR email address.</param>
        /// <param name="clientToken">Use the Client Token. Please generate it from the Applications section under the Production &amp; Sandbox tabs</param>
        ...
        /// <summary>
        /// Comment on shared idea This service allows a user to comment on a idea. The following fields(key:value) are required to be present in the Comment JSON object. Refer to the Model &amp; Model Schema of the expected JSON Object for the body of this API.&lt;/br&gt;&lt;b&gt;Required fields &lt;/br&gt;1. ideaId (Path Parameter)&lt;/br&gt;2. commentText &lt;/br&gt;
        /// </summary>
        /// <exception cref="IO.IEngage.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="ideaId">idea Id</param>
        /// <param name="requesterId">requesterId can be user id OR email address.</param>
