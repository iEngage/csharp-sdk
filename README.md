# IO.IEngage - the C# library for the Stakeholder engagement API
...
## Documentation for Models
 ...
 - [Model.CommandInfo](docs/CommandInfo.md)
 - [Model.Comment](docs/Comment.md)
 - [Model.ContentDisposition](docs/ContentDisposition.md)
 - [Model.DataFlavor](docs/DataFlavor.md)
 - [Model.DataHandler](docs/DataHandler.md)
 ...
 - [Model.OutputStream](docs/OutputStream.md)
